...
export const blogPosts: BlogPost[] = [
  ...
  {
    title: '新店美甲教學｜凝膠美甲課程與手足護理完整指南',
    excerpt: '新店美甲教學從基礎到進階，整理凝膠課程、手足護理與小班制學習方式。',
    date: '2025-07-10',
    href: '/blog/post-11/',
    cluster: 'courses',
  },
  {
    title: '景美手部保養推薦｜景美美甲店的專業護理與凝膠美甲',
    excerpt: '整理景美手部基礎與深層保養內容，以及凝膠美甲的搭配方式與到店資訊。',
    date: '2025-07-10',
    href: '/blog/post-10/',
    cluster: 'hand-foot-care',
  },
  {
    title: '新店凝膠美甲與手足護理｜美甲課程從基礎到進階',
    excerpt: '整理新店凝膠美甲、手足護理與美甲課程的服務選擇及到店方式。',
    date: '2025-07-08',
    href: '/blog/post-9/',
    cluster: 'gel-care',
  },
  {
    title: '景美足部保養推薦｜景美美甲店的深層護理體驗',
    excerpt: '介紹景美足部基礎保養、深層保養與潤澤課程，協助依雙腳狀況選擇。',
    date: '2025-07-08',
    href: '/blog/post-8/',
    cluster: 'hand-foot-care',
  },
  {
    title: '新店凝膠美甲｜造型設計與美甲課程完整指南',
    excerpt: '整理新店凝膠美甲、造型設計與美甲課程的服務內容及交通資訊。',
    date: '2025-07-06',
    href: '/blog/post-7/',
    cluster: 'gel-care',
  },
  {
    title: '景美美甲店推薦｜手部保養與凝膠美甲的專業選擇',
    excerpt: '從手部保養、凝膠美甲到交通位置，整理挑選景美美甲店時可參考的重點。',
    date: '2025-07-06',
    href: '/blog/post-6/',
    cluster: 'style-visit',
  },
  {
    title: '足部深層保養攻略｜台北美甲沙龍的專業護理體驗',
    excerpt: '完整整理足部基礎、深層與潤澤保養方案的差異與選擇方式。',
    date: '2025-06-20',
    href: '/blog/post-5/',
    cluster: 'hand-foot-care',
  },
  {
    title: '景美美甲推薦｜凝膠美甲價格、款式與預約完整指南',
    excerpt: '整理景美凝膠美甲款式、價格資訊、選店技巧與預約方式。',
    date: '2025-06-15',
    href: '/blog/post-4/',
    cluster: 'style-visit',
  },
